...
import { BadRequestError, IAuthDocument, IEmailMessageDetails, firstLetterUppercase, lowerCase, uploads } from '@salman-eng1/marketplace-shared';
...
const filename = `user-${profilePublicId}-${Date.now()}.jpeg`;
...
export async function create(req: Request, res: Response): Promise<void> {
  ...
  const uploadResult= upload.single(profilePicture)
