import { ISellerDocument } from '@salman-eng1/marketplace-shared';
...
const SellerSchema: Schema = new Schema({
    ...
    languages: [{ language: { type: String, required: true }, level: { type: String, required: true } }],
    ...
    recentDelivery: { type: Date, default: 0 },
    experience: [
      {
  ...
  const SellerModel: Model<ISellerDocument> = model<ISellerDocument>('ISeller', SellerSchema);
